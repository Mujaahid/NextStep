...
$(document).ready(function(){
    $('.job-application').click(function() {
        $('.job-app-container').fadeIn(500);
    })
    $('.close-job-app').click(function(){
        $('.job-app-container').fadeOut(500);
    })
})
// Job app modal
...
// warning modal
$(document).ready(function(){
    $('.job-app-btn').click(function() {
        $('.warning-background').fadeIn(500);
    })
    $('.close-job-app-warning').click(function(){
        $('.warning-background').fadeOut(500);
    })
})
// warning modal
